...
---
= StorageGRID の SAML 用に Entra ID でエンタープライズアプリケーションを作成する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Entra IDを使用して、システム内のSAML用管理ノードごとにエンタープライズアプリケーションを作成します。
...
== ステップ2：エンタープライズアプリケーションを作成し、StorageGRID SSO構成を保存する
...
== ステップ3：各管理ノードのSAMLメタデータをダウンロードする
...
== ステップ4：SAMLメタデータを各エンタープライズアプリケーションにアップロードする
...
. link:../admin/configure-sso-saml.html#test-sso["各アプリケーションをテストする"]。
