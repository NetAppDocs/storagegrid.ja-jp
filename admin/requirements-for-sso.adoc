...
StorageGRID は複数の SSO ID プロバイダー（IdP）をサポートしています。

[role="tabbed-block"]
====
.OIDC
--
以下の SSO IdPs は OpenID Connect （OIDC） でサポートされています：
...
.SAML
--
以下の SSO IdPs は、Security Assertion Markup Language 2.0 （SAML 2.0） でサポートされています：
