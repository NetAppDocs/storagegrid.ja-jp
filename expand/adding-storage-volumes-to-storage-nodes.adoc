...
sidebar: sidebar 
keywords: storage volumes, expand, expansion, add, storage nodes, adding storage capacity, StorageGRID 
...
---
= StorageGRIDシステムにストレージボリュームを追加する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_page_storage_tables_vol_expansion.png["Nodes ページストレージテーブル"]
