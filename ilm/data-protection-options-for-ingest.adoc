...
summary: ILMルールを作成する際、Dual commit、Strict、またはBalancedのいずれかを指定することで、取り込み時にオブジェクトを保護できます。 
---
...
image:ingest_object_lifecycle.png["各取り込みオプションでオブジェクトがどのように取り込まれるかを示す図"]
