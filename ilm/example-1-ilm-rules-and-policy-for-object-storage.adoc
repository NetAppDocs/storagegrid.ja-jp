...
---
= StorageGRID での基本的なオブジェクトの保護と保持に関する ILM ルールとポリシー
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ilm_rule_two_copies_two_data_centers.png["例1のILMルール1：オブジェクトデータを2つのサイトにコピーします"]
...
|===
image:ilm_rule_ec_for_s3_bucket_finance_records.png["例1のILMルール2：イレイジャーコーディングプロファイルとバケットの照合"]
...
+
image:policy_1_configured_policy.png["例1のILMポリシー"]
