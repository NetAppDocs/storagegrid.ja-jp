...
---
= StorageGRID のイレイジャー コーディングについて
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ec_three_sites_4_plus_2.png["イレイジャーコーディング、 3 サイト、 4+2"]
...
image:ec_recoverable_4_plus_2.png["イレイジャーコーディング、リカバリ可能、 4+2"]

3 つ以上のストレージノードが失われると、オブジェクトを読み出せなくなります。

image:ec_unrecoverable_4_plus_2.png["イレイジャーコーディング、リカバリ不能、 4+2"]
