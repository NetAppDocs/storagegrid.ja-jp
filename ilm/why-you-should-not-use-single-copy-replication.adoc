...
image:ilm_replication_make_1_copy.png["ILM レプリケーションでコピーを 1 つ作成"]
...
image:ilm_replication_make_1_copy_sn_fails.png["ILM レプリケーションの Make 1 Copy SN は失敗します"]
...
image:ilm_replication_make_2_copies_sn_fails.png["ILM レプリケーションの Make 2 Copies SN は失敗します"]
