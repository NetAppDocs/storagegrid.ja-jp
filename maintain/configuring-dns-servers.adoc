...
summary: DNSサーバーを追加、削除、更新することで、IPアドレスではなく完全修飾ドメイン名（FQDN）ホスト名を使用できるようになります。 
---
= StorageGRIDでDNSサーバーを設定する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.手順
. *メンテナンス* > *ネットワーク* > *DNS サーバー* を選択します。
. IPアドレスの横にある削除アイコンimage:icon-x-to-remove.png["削除アイコン"]を選択します。
. [ 保存（ Save ） ] を選択します。
