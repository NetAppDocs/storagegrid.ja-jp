...
---
= StorageGRIDにおけるプライマリまたは非プライマリ管理ノードの復旧
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.選択肢
* link:recovering-from-primary-admin-node-failures.html["同じプライマリ管理ノードを使用してプライマリ管理ノードを復旧する"]
* link:recovering-from-primary-admin-node-failures-using-npan.html["プライマリ管理ノードの障害から非プライマリ管理ノードを使用して復旧する"]
