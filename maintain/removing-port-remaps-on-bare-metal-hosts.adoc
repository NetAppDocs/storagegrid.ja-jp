...
---
= ベアメタルホスト上のStorageGRIDポート再マッピングを削除
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
ADMIN_NETWORK_TARGET_TYPE = DedicatedInterface
...
CLIENT_NETWORK_TARGET_TYPE = DedicatedInterface
...
GRID_NETWORK_TARGET_TYPE = DedicatedInterface
