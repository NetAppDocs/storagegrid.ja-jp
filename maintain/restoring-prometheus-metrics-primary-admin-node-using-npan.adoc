---
permalink: maintain/restoring-prometheus-metrics-primary-admin-node-using-npan.html 
sidebar: sidebar 
keywords: storagegrid, prometheus, metrics, primary admin node 
summary: プライマリ管理ノードを復旧する際に、プライマリ以外の管理ノードを使用してPrometheusメトリクスを復元します。 
---
= StorageGRID プライマリ管理ノードの復旧時に Prometheus メトリクスを復元する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
