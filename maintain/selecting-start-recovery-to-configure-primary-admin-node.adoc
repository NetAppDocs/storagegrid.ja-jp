...
summary: プライマリ管理ノードの復旧中にプライマリ管理ノードを設定するには、「Start Recovery」を選択します。 
---
= プライマリ管理ノードを設定するには、「リカバリの開始」を選択します。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
プライマリ管理ノードを交換した後は、Grid Manager で「Start Recovery」を選択し、新しいノードを障害が発生したノードの代替として構成する必要があります。
...
NOTE: 復旧処理の実行中に、*リセット*を選択すると、新しい復旧処理を開始できます。手順をリセットするとノードが不確定な状態になることを示すダイアログボックスが表示されます。
