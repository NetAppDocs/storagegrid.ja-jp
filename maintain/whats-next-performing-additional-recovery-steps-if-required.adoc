...
プライマリ管理ノード
 a| 
* link:selecting-start-recovery-to-configure-primary-admin-node.html["プライマリ管理ノードを設定するには、「リカバリの開始」を選択します。"]
* link:selecting-start-recovery-to-configure-non-primary-admin-node.html["プライマリ管理ノードを非プライマリ管理ノードを使用して復旧する"]
