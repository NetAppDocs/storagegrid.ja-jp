...
Prometheusクエリの構文の詳細については、 https://prometheus.io/docs/prometheus/latest/querying/basics/["クエリの基本"^]を参照してください。
...
+
image:nodes_page_network_traffic_graph.png["Prometheus のグラフ"]
