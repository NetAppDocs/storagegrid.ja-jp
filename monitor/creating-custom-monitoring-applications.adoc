...
---
= StorageGRID のカスタム監視アプリケーションを作成する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
利用可能なメトリクスの完全なリストを含む、メトリクスAPIの操作を表示するには、Grid Managerにアクセスしてください。ページ上部からヘルプアイコンを選択し、*APIドキュメント* > *メトリクス*を選択します。image:help_api_docs_metrics.png["[Help][API documentation][Metrics]セクション"]
