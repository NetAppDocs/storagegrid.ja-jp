...
+
image:grid-federation-connections-tab.png["グリッドフェデレーション接続タブ"]
...
+
image:grid-federation-permitted-tenants-tab.png["[Grid Federation Permitted Tenants]タブ"]
...
+
image:grid-federation-permitted-tenants-tab-for-connection.png["grid-federation-permitted-tenants-tab-for-connection"]
...
+
image:grid-federation-certificates-tab.png["grid-federation-certificates-tabの略"]
