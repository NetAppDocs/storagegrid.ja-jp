...
---
= StorageGRID グリッド フェデレーション接続を監視
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:grid_federation_connections_tab.png["グリッドフェデレーション接続タブ"]
...
+
image:grid_federation_permitted_tenants_tab.png["[Grid Federation Permitted Tenants]タブ"]
...
[[view-specific-connectionview-a-specific-connection]]
...
+
image:grid_federation_permitted_tenants_tab_for_connection.png["grid-federation-permitted-tenants-tab-for-connection"]
...
+
image:grid_federation_certificates_tab.png["grid-federation-certificates-tabの略"]
