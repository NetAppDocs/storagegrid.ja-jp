...
---
= StorageGRID でネットワークとシステムリソースを監視
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_page_network_traffic_graph.png["Nodes Page Network Traffic Graph の略"]

+
.. グリッドノードを選択した場合は、ページの「 * ネットワークインターフェイス * 」セクションまでスクロールします。
+
image:nodes_page_network_interfaces.png["Nodes ページネットワークインターフェイス"]
...
+
image:traffic_classification_policies_main_screen_w_examples.png["グラフのトラフィックポリシーの例"]

.. ポリシーに関連付けられたネットワークメトリックを示すグラフを表示するには、ポリシーの左側にあるラジオボタンを選択し、次に*Metrics*を選択します。
...
+
image:nodes_page_hardware_tab_graphs.png["ノードページハードウェアタブ"]
