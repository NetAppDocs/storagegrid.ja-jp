---
permalink: monitor/sending-eseries-autosupport-messages-through-storagegrid.html 
sidebar: sidebar 
...
* あなたはlink:../admin/admin-group-permissions.html["ストレージアプライアンス管理者またはRoot Access権限"]があります。
...
+
image:autosupport_santricity_home_page.png["AutoSupport SANtricity のホームページ"]
...
+
image:autosupport_santricity_operations.png["AutoSupport SANtricity AutoSupport 処理"]
...
+
image:autosupport_configure_delivery_santricity.png["AutoSupport は AutoSupport 配信方法 SANtricity を設定します"]
