...
---
= StorageGRID SANtricity System Manager タブを表示します
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: SANtricity System Manager を使用して E シリーズの AutoSupport のプロキシを設定するには、link:sending-eseries-autosupport-messages-through-storagegrid.html["StorageGRID経由でEシリーズAutoSupportパッケージを送信"]を参照してください。
...
image:nodes_page_santricity_tab.png["ノードページの SANtricity タブ"]
