...
[[api-operation-consistency-controlspecify-consistency-for-api-operation]]
...
[[bucket-consistencyspecify-consistency-for-bucket]]
...
[[how-consistency-and-ilm-rules-interacthow-consistency-and-ilm-rules-interact-to-affect-data-protection]]
