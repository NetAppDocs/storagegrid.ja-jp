...
summary: VMware OVF ツールを使用して、 StorageGRID でグリッドノードの導入を自動化できます。StorageGRID の設定を自動化することもできます。 
---
= StorageGRIDでVMware vSphereを使用してグリッドノードの導入を自動化
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* VMware OVF ツールがインストールされ、正しく構成されています。
