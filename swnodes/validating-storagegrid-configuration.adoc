...
image:rhel_node_configuration_file_output.gif["この図には説明が付随しています。"]
...
image:rhel_node_configuration_file_output_with_errors.gif["この図には説明が付随しています。"]
