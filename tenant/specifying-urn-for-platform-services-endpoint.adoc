...
[listing]
----
urn:aws:sns:region:account-id:sns-topic-name
----
+
Kafkaエンドポイントを指定します。
...
[listing]
----
urn::kafka:::kafka-topic-name
----
+

NOTE: オプションで、Kafkaエンドポイントを指定する際に `mysite`を含めることができます： `urn:mysite:kafka:::kafka-topic-name`
...
[listing]
----
urn:mysite:webhook:::webhook-name
----
* 検索統合：
+
[listing]
----
urn:mysite:es:::domain-name/index-name/type-name
----
+
