...
image:tenant_shares_identity_federation.png["テナントがアイデンティティフェデレーションを共有"]
...
+
image:ldap_service_type.png["LDAP サービスタイプオプションを示すアイデンティティフェデレーションページ"]
...
+
image:identity_federation_test_connection.png["アイデンティティフェデレーションでは、バインドユーザ名の形式を検証するよう求められ"]
