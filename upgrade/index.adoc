...
これらのトピックを確認して、StorageGRID 12.1の新機能と強化点について学び、非推奨または削除された機能があるかどうかを確認し、StorageGRID APIの変更点について調べてください。

* link:how-your-system-is-affected-during-upgrade.html["アップグレード中にシステムが受ける影響"]
* link:../release-notes/whats-new.html["StorageGRID 12.1の新機能"]
* link:../release-notes/removed-or-deprecated-features.html["削除または廃止された機能"]
* link:../release-notes/changes-to-grid-management-api.html["Grid 管理 API に対する変更"]
* link:../release-notes/changes-to-tenant-management-api.html["テナント管理 API に変更が加えられました"]
