...
StorageGRID のドキュメント
 a| 
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["リリースノート"^]。NetAppアカウントでサインインするか、アカウントを作成してリリースノートにアクセスする必要があります。アップグレードを開始する前に、必ずこれらの内容をよくお読みください。
